...
# AVERAGE MODEL ====
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'CLASS I')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'CLASS II')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'VAR/VECM - M')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'BVAR - M')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'VAR/VECM - Q')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'BVAR - Q')
plot_forecast_error(COVID_forecast_compound_ipca, 1, 'AVERAGE MODEL')
